...
Актуальность: 14.11.2017 2:16:52

## Пользователи

Общее количество пользователей: 381
Всего репозиториев: 647
...
Общее количество репозиториев: 579
...
| [fokusov/MyMoney](https://github.com/fokusov/MyMoney) | "Мои деньги" - конфигурация на платформе 1С 8.3 |  0 | 0 | 0 |
...
| [alexandr-yang/1c-report-competitiveness-index](https://github.com/alexandr-yang/1c-report-competitiveness-index) | Отчет «Индекс конкурентоспособности» |  0 | 0 | 0 |
...
| [devzv/1cSocIntegration](https://github.com/devzv/1cSocIntegration) |  |  0 | 0 | 0 |
...
| [alkoleft/ones_universal_tools](https://github.com/alkoleft/ones_universal_tools) | Набор универсальных инструментов для программиста 1с |  1 | 1 | 0 |
...
| [silverbulleters/dev-machine](https://github.com/silverbulleters/dev-machine) |  |  1 | 1 | 1 |
...
| [BlackDrak0n/oscript-AutoUpdateIB](https://github.com/BlackDrak0n/oscript-AutoUpdateIB) | Автоматическое обновление информационных баз |  19 | 19 | 8 |
...
| [arkuznetsov/cpdb](https://github.com/arkuznetsov/cpdb) | Приложение oscript для копирования баз данных 1C / MS SQL и развертывания на целевой системе. |  14 | 14 | 6 |
...
| [silverbulleters/vanessa-behavior2](https://github.com/silverbulleters/vanessa-behavior2) | репозиторий для нового процесса разработки |  20 | 20 | 15 |
| [artbear/1bdd](https://github.com/artbear/1bdd) | 1BDD для OneScript - консольный фреймворк, реализующий BDD для проекта OneScript. Для Windows и Linux. |  21 | 21 | 11 |
...
| [silverbulleters/sonar-l10n-ru](https://github.com/silverbulleters/sonar-l10n-ru) | Russian Language Pack for SonarQube |  10 | 10 | 2 |
...
| [arkuznetsov/yadt](https://github.com/arkuznetsov/yadt) | Приложение oscript для развертывания конфигураций 1С на базах подключенных к хранилищу. |  14 | 14 | 2 |
...
| [BlizD/Tasks](https://github.com/BlizD/Tasks) | Конфигурация "Управление задачами" с использованием библиотеки стандартных подсистем. Канбан доска. Загрузка изменений из хранилища 1с. |  48 | 48 | 27 |
| [silverbulleters/vanessa-runner](https://github.com/silverbulleters/vanessa-runner) | утилита автоматизация базовых операций разработчика 1С |  48 | 48 | 26 |
| [oscript-library/packman](https://github.com/oscript-library/packman) | Сборка тиражируемых дистрибутивов 1С |  39 | 39 | 13 |
| [ret-Phoenix/SmartConfigurator](https://github.com/ret-Phoenix/SmartConfigurator) | Расширяем конфигуратор без Снегопата и ТурбоКонфа |  41 | 41 | 15 |
| [1C-Company/dt-demo-configuration](https://github.com/1C-Company/dt-demo-configuration) |  |  65 | 65 | 41 |
| [xDrivenDevelopment/xUnitFor1C](https://github.com/xDrivenDevelopment/xUnitFor1C) | Unit testing tools for 1C:Enterprise 8 platform (http://v8.1c.ru) |  224 | 224 | 88 |
| [silverbulleters/vanessa-behavior](https://github.com/silverbulleters/vanessa-behavior) | BDD for 1C:Enterprise inspired by Cucumber |  307 | 307 | 77 |
| [oscript-library/gitsync](https://github.com/oscript-library/gitsync) | Синхронизация хранилища 1С с репозиторием git |  68 | 68 | 27 |
...
| [oscript-library/v8runner](https://github.com/oscript-library/v8runner) | Управление запуском 1С из командной строки |  24 | 24 | 14 |
...
| [silverbulleters/vanessa-agiler](https://github.com/silverbulleters/vanessa-agiler) | EffectCup and SCRUM for 1C:Enterprise |  21 | 21 | 7 |
| [oscript-library/opm](https://github.com/oscript-library/opm) | Пакетный менеджер OneScript |  22 | 22 | 12 |
| [silverbulleters/deployka](https://github.com/silverbulleters/deployka) | Continuous Delivery for 1C:Enterprise |  25 | 25 | 16 |
...
| [silverbulleters/add](https://github.com/silverbulleters/add) | Разработка с управляемым качеством на 1С |  4 | 4 | 4 |
| [silverbulleters/logos-1c](https://github.com/silverbulleters/logos-1c) | Подсистема логирования в стиле log4j |  4 | 4 | 0 |
...
| [Khorevaa/v8storage](https://github.com/Khorevaa/v8storage) | Библиотека для работы с хранилищем 1С |  7 | 7 | 1 |
| [psyriccio/regex1c](https://github.com/psyriccio/regex1c) | Регулярные выражения в 1С (XDTO) |  8 | 8 | 0 |
...
| [oscript-library/tool1cd](https://github.com/oscript-library/tool1cd) | Программная скриптовая обертка для популярной утилиты чтения файловых баз данных tool1cd от @awa15 |  5 | 5 | 2 |
...
| [pintov/1c-jwt](https://github.com/pintov/1c-jwt) | HMAC & JSON Web Token implementation in 1C:Enterprise |  7 | 7 | 0 |
...
| [1823244/Course_CI_CD](https://github.com/1823244/Course_CI_CD) | Курс CI-CD от Silverbulleters. Заметки. Настройки. Полезности. |  0 | 0 | 0 |
| [oNikolaev/1Cnvmf](https://github.com/oNikolaev/1Cnvmf) |  |  0 | 0 | 0 |
...
| [ripreal/1C_HomeAssistant](https://github.com/ripreal/1C_HomeAssistant) | Мобильное приложение на 1С 8.3.10. для Android, которое помогает с организацией различных работ по дому (ремонт, строительство и т.д.). |  1 | 1 | 0 |
