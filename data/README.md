...
Актуальность: 15.09.2017 2:16:43

## Пользователи

Общее количество пользователей: 325
Всего репозиториев: 561
...
Общее количество репозиториев: 491
...
| [silverbulleters/dev-machine](https://github.com/silverbulleters/dev-machine) |  |  0 | 0 | 0 |
...
| [Lead-Bullets/QL-Parser](https://github.com/Lead-Bullets/QL-Parser) | :ru: 1C:QL parser for free |  0 | 0 | 0 |
...
| [Lead-Bullets/Radar](https://github.com/Lead-Bullets/Radar) | 86Ж6 |  0 | 0 | 1 |
...
| [BDskii/gitterM](https://github.com/BDskii/gitterM) |  |  0 | 0 | 0 |
| [asosnoviy/synerdocs](https://github.com/asosnoviy/synerdocs) |  |  0 | 0 | 0 |
| [haleevra/medagent](https://github.com/haleevra/medagent) |  |  0 | 0 | 0 |
...
| [Lead-Bullets/BSL-Parser](https://github.com/Lead-Bullets/BSL-Parser) | :ru: 1C:BSL parser for free |  3 | 3 | 2 |
...
| [silverbulleters/vanessa-behavior2](https://github.com/silverbulleters/vanessa-behavior2) | репозиторий для нового процесса разработки |  17 | 17 | 15 |
| [Stepa86/1C-Gitter](https://github.com/Stepa86/1C-Gitter) | Конфигурация 1С для выгрузки коммитов из хранилища в GIT |  15 | 15 | 3 |
...
| [Stepa86/1C-Deploy-and-CopyDB](https://github.com/Stepa86/1C-Deploy-and-CopyDB) | Набор скриптов для деплоя базы 1С через хранилище и копирование через sql-бекап одной базы в другую |  19 | 19 | 8 |
| [oscript-library/opm](https://github.com/oscript-library/opm) | Пакетный менеджер OneScript |  18 | 18 | 12 |
| [pbazeliuk/IHL](https://github.com/pbazeliuk/IHL) | Data composition result output processor extension |  14 | 14 | 4 |
| [BlackDrak0n/oscript-AutoUpdateIB](https://github.com/BlackDrak0n/oscript-AutoUpdateIB) | Автоматическое обновление информационных баз |  12 | 12 | 7 |
...
| [oscript-library/gitsync](https://github.com/oscript-library/gitsync) | Синхронизация хранилища 1С с репозиторием git |  64 | 64 | 26 |
...
| [1C-Company/dt-demo-configuration](https://github.com/1C-Company/dt-demo-configuration) |  |  65 | 65 | 39 |
| [silverbulleters/vanessa-behavior](https://github.com/silverbulleters/vanessa-behavior) | BDD for 1C:Enterprise inspired by Cucumber |  281 | 281 | 77 |
| [xDrivenDevelopment/xUnitFor1C](https://github.com/xDrivenDevelopment/xUnitFor1C) | Unit testing tools for 1C:Enterprise 8 platform (http://v8.1c.ru) |  209 | 209 | 83 |
...
| [oscript-library/packman](https://github.com/oscript-library/packman) | Сборка тиражируемых дистрибутивов 1С |  36 | 36 | 13 |
...
| [ret-Phoenix/oscript-sql](https://github.com/ret-Phoenix/oscript-sql) | Компонент для работы с базой sqlite из onescript |  31 | 31 | 5 |
...
| [ret-Phoenix/SmartConfigurator](https://github.com/ret-Phoenix/SmartConfigurator) | Расширяем конфигуратор без Снегопата и ТурбоКонфа |  34 | 34 | 13 |
...
| [SmokyAce/integration-1c-redmine](https://github.com/SmokyAce/integration-1c-redmine) | Внешняя обработка для 1С:Предприятия 8 - "клиент" для работы с системой управления проектами "Redmine" |  4 | 4 | 5 |
...
| [arkuznetsov/cpdb](https://github.com/arkuznetsov/cpdb) |  |  8 | 8 | 5 |
...
| [cybjavax/1cBuildPack](https://github.com/cybjavax/1cBuildPack) |  |  6 | 6 | 2 |
| [Lead-Bullets/OneShell](https://github.com/Lead-Bullets/OneShell) | Translator: extended 1C:BSL → PowerShell |  6 | 6 | 3 |
...
| [artbear/1commands](https://github.com/artbear/1commands) | Библиотека для упрощения работы c запуском различных приложений и командных файлов (cmd, bat, bash) из oscript. |  7 | 7 | 5 |
| [YPermitin/EventLogAnalyzer-for-1C-Enterprise-8.x](https://github.com/YPermitin/EventLogAnalyzer-for-1C-Enterprise-8.x) | Отчет для просмотра и анализа журнала регистрации |  6 | 6 | 0 |
...
| [bia-tech/precommit4onec](https://github.com/bia-tech/precommit4onec) | Утилита для автоматической обработки исходных файлов конфигурации, внешних отчетов и обработок для платформы 1С:Предприятие при помещении в репозиторий git |  1 | 1 | 0 |
...
| [binexekb/ExchangePlan77](https://github.com/binexekb/ExchangePlan77) |  |   |  |  |
| [ikhlapov/all1c](https://github.com/ikhlapov/all1c) | Внешние файлы 1С |   |  |  |
