...
Актуальность: 10.12.2017 18:12:20

## Пользователи

Общее количество пользователей: 404
Всего репозиториев: 690
...
Общее количество репозиториев: 620
...
| [khorevaa/1cli](https://github.com/khorevaa/1cli) |  |  0 | 0 | 0 |
...
| [arkuznetsov/cpdb](https://github.com/arkuznetsov/cpdb) | Приложение oscript для копирования баз данных 1C / MS SQL и развертывания на целевой системе. |  16 | 16 | 10 |
...
| [Stepa86/1C-Deploy-and-CopyDB](https://github.com/Stepa86/1C-Deploy-and-CopyDB) | Набор скриптов для деплоя базы 1С через хранилище и копирование через sql-бекап одной базы в другую |  20 | 20 | 10 |
...
| [silverbulleters/sonar-l10n-ru](https://github.com/silverbulleters/sonar-l10n-ru) | Russian Language Pack for SonarQube |  12 | 12 | 2 |
...
| [BlizD/Tasks](https://github.com/BlizD/Tasks) | Конфигурация "Управление задачами" с использованием библиотеки стандартных подсистем. Канбан доска. Загрузка изменений из хранилища 1с. |  52 | 52 | 29 |
...
| [silverbulleters/vanessa-behavior](https://github.com/silverbulleters/vanessa-behavior) | BDD for 1C:Enterprise inspired by Cucumber |  314 | 314 | 78 |
| [oscript-library/gitsync](https://github.com/oscript-library/gitsync) | Синхронизация хранилища 1С с репозиторием git |  69 | 69 | 27 |
| [EvilBeaver/oscript-library](https://github.com/EvilBeaver/oscript-library) | Библиотека полезных скриптов для 1Script |  108 | 108 | 48 |
...
| [Stepa86/1C-Gitter](https://github.com/Stepa86/1C-Gitter) | Конфигурация 1С для выгрузки коммитов из хранилища в GIT |  23 | 23 | 4 |
...
| [khorevaa/1cli](https://github.com/khorevaa/1cli) |  |   |  |  |
