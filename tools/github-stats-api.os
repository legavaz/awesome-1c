    ...
    Попытка
        Пока ОсталосьОбработать > 0 Цикл
            ...
            Для каждого ЭлементРезультата из СписокРезультатовПоиска Цикл
                ...
                Иначе
                    Репозитторий = ЭлементРезультата;
            	КонецЕсли;
                ...
                Важность = Репозитторий.Получить("stargazers_count");
                Популярность = Репозитторий.Получить("watchers_count");
                Вовлеченность = Репозитторий.Получить("forks_count");
