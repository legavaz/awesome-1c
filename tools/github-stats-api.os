...
Процедура ВывестиРезультатыПоискаВMarkdown()
    ...
    || Репозиторий | Описание | URL | ВЖН | ППЛ | ЗВЛ |
    ||---|---|---|---|---|---|
    |" + ТаблицуЗначенийВMarkdownТаблицу(РепозиторииOS, Истина) + "
    |");
...
Функция СоответствиеВMarkdownТаблицу(_соответствие)
    ...
    Для каждого ключЗначение Из отсортированноеСоответствие Цикл
        ...
        ключЗначение.Ключ + " | [link](" + ключЗначение.Значение + ") 
        |";
...
Функция ТаблицуЗначенийВMarkdownТаблицу(_Таблица, ВыводитьСтатистику = Ложь)
    ...
    Для каждого СтрокаТаблицы Из _Таблица Цикл
        ...
        СтрокаТаблицы.НаименованиеПроекта + " | " + СтрокаТаблицы.Описание + " | [link](" + СтрокаТаблицы.URL + ") |" + строкаСтатистики + "
        |";
