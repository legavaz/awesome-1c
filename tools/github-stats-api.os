...
Функция СортироватьПоКлючу(Знач _соответствие)
	...
	осортированноеСоответствие = Новый Соответствие;
		
    Для каждого ЭлементСписка Из _списокКлючей Цикл
		осортированноеСоответствие[ЭлементСписка.Значение] = _соответствие.Получить(ЭлементСписка.Значение);
    КонецЦикла;
	
	Возврат осортированноеСоответствие;
